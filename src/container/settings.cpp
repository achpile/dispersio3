...
***********************************************************************/
bool ach::Settings::isDefault()
{
	return !file_exists(FILE_SETTINGS);
}
...
***********************************************************************/
bool ach::Settings::isTimer()
{
	return json_object_get_branch_boolean(data, "Game.Timer");
}
...
{
	return json_object_get_branch_integer(data, "Audio.Music") * 3;
}
